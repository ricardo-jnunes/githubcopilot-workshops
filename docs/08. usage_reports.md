...
- Free Allocation:
    ...
    - Private repositories receive free minutes based on the plan:
        ...
        - GitHub Enterprise: 50,000 minutes/mon
...
See [Git Large File Storage billing](https://docs.github.com/en/billing/concepts/product-billing/git-lfs)
...
# Reference
https://learn.microsoft.com/en-us/training/modules/github-introduction-products/7-metered-usage-consumption-reports
