...
2. [Open this repository with Codespaces](https://github.com/codespaces/new/MicrosoftDocs/mslearn-copilot-codespaces-python)
    2.1 Reference https://github.com/MicrosoftDocs/mslearn-advanced-copilot/blob/main/README.md

## Workshop objectives
- Exercise inline suggestions
- Create tests
